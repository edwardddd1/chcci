<template>
      <div class="auth-shap position-relative">
        ...
        <rect y="7.48828" width="10" height="10" rx="2" transform="rotate(-51.9256 0 7.48828)" fill="#044b8dff"/>
        </svg>
        ...
        <rect y="6.78516" width="9.51587" height="9.51587" rx="2" transform="rotate(-51.9256 0 6.78516)" fill="#044b8dff"/>
        </svg>
